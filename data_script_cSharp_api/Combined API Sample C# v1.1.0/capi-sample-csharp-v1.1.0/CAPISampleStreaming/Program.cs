...
namespace NDI.CapiSampleStreaming
{
    ...
    class Program
    {
        ...
        private static bool InitializePorts(Capi cAPI)
        {
            ...
            else if (!tool.LoadSROM("sroms/brainlab.rom"))
            {
        ...
        private static void trackfor(int runTime, Capi cAPI, int flagP)
        {
            cAPI.SetLogger(log);
            ...
            //cmd = cAPI.StartStreaming("BX2 --6d=tools", "BX2");
